...
class TestHybridSearchTool:
    ...
    def test_returns_results(self, mock_chunk_embeddings, mock_generator, mock_fts_results):
        ...
        with patch('src.tools.hybrid_search_tools._get_generator') as mock_get_gen, \
             patch('src.tools.hybrid_search_tools.load_chunk_embeddings') as mock_load, \
             patch('src.tools.hybrid_search_tools.full_text_search') as mock_fts, \
             patch('src.tools.hybrid_search_tools.rerank_results') as mock_rerank:
    ...
    def test_diverse_flag(self, mock_chunk_embeddings, mock_generator, mock_fts_results):
        ...
        with patch('src.tools.hybrid_search_tools._get_generator') as mock_get_gen, \
             ...
             patch('src.tools.hybrid_search_tools.full_text_search') as mock_fts, \
             patch('src.tools.hybrid_search_tools.rerank_results') as mock_rerank, \
             patch('src.tools.hybrid_search_tools.find_top_k') as mock_topk, \
             patch('src.tools.hybrid_search_tools.maximal_marginal_relevance') as mock_mmr:
...
def test_hybrid_search_uses_chunks():
    ...
    with patch("src.tools.hybrid_search_tools.load_chunk_embeddings") as mock_chunks, \
         patch("src.tools.hybrid_search_tools._get_generator") as mock_get_gen, \
         patch("src.tools.hybrid_search_tools.rerank_results") as mock_rerank, \
         patch("src.tools.hybrid_search_tools.find_top_k") as mock_topk, \
         patch("src.tools.hybrid_search_tools.full_text_search") as mock_fts, \
         patch("src.tools.hybrid_search_tools.reciprocal_rank_fusion") as mock_rrf:
