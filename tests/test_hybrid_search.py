...
class TestReciprocalRankFusion:
    ...
    def test_rrf_preserves_metadata(self):
        ...
        fts = [
            make_fts_result(
                "ch-A", book_id="book-1", book_title="My Book", chapter_number=3, chapter_title="Chapter Three"
            )
        ]
        sem = []
...
class TestMaximalMarginalRelevance:
    ...
    def diverse_setup(self, embedding_dim):
        ...
        results = [{"chapter_id": f"ch-{i}", "rrf_score": 1.0 / (60 + i + 1)} for i in range(5)]
    ...
    def test_mmr_reduces_redundancy(self, diverse_setup):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, lambda_param=0.3, top_k=3)
    ...
    def test_mmr_lambda_1_pure_relevance(self, diverse_setup):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, lambda_param=1.0, top_k=5)
    ...
    def test_mmr_lambda_0_max_diversity(self, diverse_setup):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, lambda_param=0.0, top_k=3)
    ...
    def test_mmr_single_result(self):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, top_k=5)
    ...
    def test_mmr_empty_results(self):
        ...
        mmr_results = maximal_marginal_relevance([], embeddings, metadata, query, top_k=5)
    ...
    def test_mmr_top_k_limits_output(self, diverse_setup):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, top_k=2)
    ...
    def test_mmr_missing_embeddings_graceful(self):
        ...
        mmr_results = maximal_marginal_relevance(results, embeddings, metadata, query, top_k=3)
